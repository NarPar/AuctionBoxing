...
namespace Auction_Boxing_2
{
    class LoadOut_Display
    {
        ...
        public LoadOut_Display(SpriteFont font, Rectangle bounds, Texture2D background, Texture2D bar)
        {
            this.font = font;
            this.bounds = bounds;
        ...
        public void SetItem(Item item)
        {
            ...
            float maxmovement = 10000;
            float maxattack = 10000;
            float maxdefense = 10000;
            float maxcooldown = 10000;
            ...
            barPositions[5].Width = (int)(fullBar * 1 - (cooldown / Tools.displayMaxCooldown));
            Debug.WriteLine("width = " + barPositions[5].Width);
