...
namespace Auction_Boxing_2
{
    ...
    class PlayerStatDisplay
    {
        ...
        public PlayerStatDisplay(SpriteFont font, int player_index, BoxingPlayer player,Input_Handler input, Rectangle bounds, Texture2D background, Texture2D bar)
        {
            ...
            int barWidth = bounds.X + bounds.Width - barX - 4;
            ...
            rHealth.Width = (int)(barWidth * (health / player.MaxHealth));
            rStamina.Width = (int)(barWidth * (stamina / player.MaxStamina));
